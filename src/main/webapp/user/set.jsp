    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <div class="layui-tab-content" style="padding: 20px 0;">
        <div class="layui-form layui-form-pane layui-tab-item layui-show">
          <form action="/change" enctype="multipart/form-data">
            <input type='hidden'  id='id' name="userId" value ="${sessionScope.user.userId}"/>
          ...
          <div class="layui-form layui-form-pane layui-tab-item">
            <form >
              ...
              <div class="layui-form-item">
                <input type="button"   onclick=update()  class="layui-btn" lay-filter="*"   value="确认修改" />
              </div>
            </form>
          </div>
...
<script>
  function update() {
      var req={};
      req.userId=$("#id").val().trim();
      req.pass=$("#L_pass").val().trim();
      req.repass=$("#L_repass").val().trim();
